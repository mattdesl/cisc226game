...
public class TextureUtils {
	...
	/**
	 * Creates a NPOT texture with NEAREST filtering and a wrap
	 * mode of CLAMP_TO_EDGE (or CLAMP if GL < 1.2).
	 * This is for maximum compatibility with ATI drivers. 
	 * 
	 * If NPOT is not supported, the resulting texture will be made
	 * to the next greatest power of two.
	 * 
	 * @param width
	 * @param height
	 * @return
